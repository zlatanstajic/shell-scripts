...
# A single complete -W line over all 13 names exceeds 80 cols, so build the list
# across wrapped assignments, then register each name.
_ssc_names="backup decrypt-env-files dev-setup generate-password"
_ssc_names="$_ssc_names git-copy hash-filenames my-scripts php-switch"
_ssc_names="$_ssc_names restore-vscode-folder shutdown-guard splice-images"
_ssc_names="$_ssc_names splice-videos tampermonkey-install"
